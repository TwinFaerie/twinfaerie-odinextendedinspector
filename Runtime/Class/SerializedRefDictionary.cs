...
{
    /// <summary>
    /// Overlay for the <see cref="Dictionary{TKey, TValue}"/> to allow serialization of the key/value pairs with value as abstract class
    /// </summary>
    [Serializable]
    public class SerializedRefDictionary<TK, TV> : IDictionary<TK, TV>, ISerializationCallbackReceiver
    {
        [Serializable]
